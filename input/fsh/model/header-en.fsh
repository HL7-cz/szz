...
* author 1..* Base "A.1.5 - Author (by whom the Shared health record was/were authored). Multiple authors could be provided." """Author (by whom the Shared health record was/were authored). Multiple authors could be provided."""
...
* documentMetadata.type 1..1 CodeableConcept "A.1.6.2 - Document type" """Identifies the type of document at hand, e.g. Shared health record."""
* documentMetadata.status 1..1 CodeableConcept "A.1.6.3 - Document status" """The status of the Shared health record report. E.g., preliminary, final."""
* documentMetadata.dateTime 1..1 dateTime "A.1.6.4 - Report date and time" """Date and time of the Shared health record creation."""
* documentMetadata.title 1..1 string "A.1.6.5 - Document title" """Document title, fix value ''Shared health record''."""
