...
* preventivniProhlidka 0..1 Base "A.3.1.3 - Výsledek vyšetření v rámci preventivní prohlídky" """"""
  ...
  * vaha 0..1 Quantity "A.3.1.3.3 - Váha" """Váha pacienta v kg."""
  * systolickyTlak 0..1 Quantity "A.3.1.3.4 - Tlak (systolický)" """Hodnota v mm Hg."""
  * diastolickyTlak 0..1 Quantity "A.3.1.3.5 - Tlak (diastolický)" """Hodnota v mm Hg."""
  * obvodPasu 0..1 Quantity "A.3.1.3.6 - Obvod pasu" """Obvod pasu v cm."""
