...
* colorectalScreening 0..1 Base "A.3.3.1 - Result of colorectal cancer screening"
  ...
  * resultBBPS 0..1 integer "A.3.3.1.4 - BBPS result" """Value 0 to 9 according to the Boston classification (BBPS – Boston Bowel Preparation Scale)."""
  ...
  * recommendedProcedure 0..1 CodeableConcept "A.3.3.1.8 - Colonoscopy exam.result: Further recomm.examinations" """Final evaluation of results by physician."""