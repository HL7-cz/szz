...
* colorectalScreening 0..1 Base "A.3.1.1 - Colorectal cancer screening test result" """Result of quantitative fecal occult blood test."""
  ...
  * levelTOKS 0..1 integer "A.3.1.1.3 - TOKS level" """Quantitative immunochemical test value (µg/g)."""
* prostateCancerScreening 0..1 Base "A.3.1.2 - Result of prostate cancer screening" """Categorical result of PSA determination according to value."""
  ...
  * levelPSA 0..1 integer "A.3.1.2.2 - PSA level (health service code reported to the health insurance company)" """Health service code reported to the insurance company based on the value of prostate-specific antigen in the patient's blood."""
